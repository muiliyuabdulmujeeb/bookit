...
from schemas.reviews.reviews import GetReviewResponseModel
...
@service_router.get("/{id}/reviews", status_code= status.HTTP_200_OK, response_model= GetReviewResponseModel)
...
@service_router.get("", status_code= status.HTTP_200_OK, response_model= GetServiceResponseModel)
